            ...
            <form className="flex flex-col gap-4">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    <div className="flex flex-col gap-2">
                        <label className="text-[14px] text-[#242424]" for="first_name">First Name <span className="text-red-500 text-[18px]">*</span></label>
                    ...
                    <div className="flex flex-col gap-2">
                        <label className="text-[14px] text-[#242424]" for="last_name">Last Name <span className="text-red-500 text-[18px]">*</span></label>
                ...
                <div className="flex flex-col gap-2">
                    <label className="text-[14px] text-[#242424]" for="display_name">Display Name <span className="text-red-500 text-[18px]">*</span></label>
                ...
                <div className="flex flex-col gap-2">
                    <label className="text-[14px] text-[#242424]" for="email">Email <span className="text-red-500 text-[18px]">*</span></label>
